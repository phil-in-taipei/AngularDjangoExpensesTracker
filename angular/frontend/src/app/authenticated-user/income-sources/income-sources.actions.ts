...
export enum IncomeSourcesActionTypes {
    ...
    IncomeSourceDeletionRequested = '[Income Source Page]  Removal of Income SourceRequested',
    IncomeSourceDeletionSaved = '[Income Sources Page] Income Source Removed',
    IncomeSourceEditCancelled= '[Edit Income Source Page] Edit Income SourceCancelled',
